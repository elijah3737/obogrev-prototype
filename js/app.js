...
function renderPage(slug) {
  ...
  const PAGES = {
    about: { title: 'О компании', body: `
      <p class="page__lead">Монолит — поставщик отопительного электрооборудования с 2010 года. Оптово-розничные продажи товаров для бытового и промышленного обогрева, проектирование и монтаж систем электрообогрева «под ключ». Более 1 млн довольных покупателей и 1000 постоянных юридических лиц.</p>
